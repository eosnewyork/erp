...
public class PriceDbWriter {	
	...
	private static double getCpuPriceMs(String _url) throws IOException {
		...
		JSONObject strTotalResources = (JSONObject) _jsonResp.get("total_resources");
...
*/
	...
	public static void updateRamPrice() throws SQLException, IOException {
		...
		if (client != null) {
			int result = sendQuery("eosram", getEosPriceUsd(strUrlEosPriceUsd), client, getRamPriceBytes(strUrlGetTableRows));
			if (result == 1) {
				//~ DEBUG
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		//~ updateRamPrice();
		getCpuPriceMs(strUrlGetAccount);
	}
